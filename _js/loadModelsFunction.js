...
function loadScummBarPirate01_head(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate01_head.js',
			function (geometry, materials){
				...
				scummBarPirate01_head.lookText = "That guy looks like a local.  He probably knows the area well.";
...
function loadScummBarPirate01_body(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate01_body.js',
			function (geometry, materials){
				...
				scummBarPirate01_body.lookText = "That guy looks like a local.  He probably knows the area well.";
...
function loadScummBarPirate06(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate06.js',
			function (geometry, materials){
				...
				scummBarPirate06.endPoint = new THREE.Vector3(-5.80, 1, 2.07);
...
function loadScummBarPirate07_head(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate07_head.js',
			function (geometry, materials){
				...
				scummBarPirate07_head.lookText = "These two are busy listening to the pirate on the left.";
				scummBarPirate07_head.epOverride = 1;
				scummBarPirate07_head.endPoint = new THREE.Vector3(-41.23, 1, 5.60);
...
function loadScummBarPirate07_body(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate07_body.js',
			function (geometry, materials){
				...
				scummBarPirate07_body.lookText = "These two are busy listening to the pirate on the left.";
				scummBarPirate07_body.epOverride = 1;
				scummBarPirate07_body.endPoint = new THREE.Vector3(-41.23, 1, 5.60);
...
function loadScummBarPirate08_head(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate08_head.js',
			function (geometry, materials){
				...
				scummBarPirate08_head.lookText = "These two are busy listening to the pirate on the left.";
				scummBarPirate08_head.epOverride = 1;
				scummBarPirate08_head.endPoint = new THREE.Vector3(-41.23, 1, 5.60);
...
function loadScummBarPirate08_body(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate08_body.js',
			function (geometry, materials){
				...
				scummBarPirate08_body.lookText = "These two are busy listening to the pirate on the left.";
				scummBarPirate08_body.epOverride = 1;
				scummBarPirate08_body.endPoint = new THREE.Vector3(-41.23, 1, 5.60);
...
function loadScummBarPirate11(){
	loader.load('../_models/_scummBar/_chars/scummBarPirate11.js',
			function (geometry, materials){
				...
				scummBarPirate11.endPoint = new THREE.Vector3(-5.80, 1, 2.07);
...
function loadScummBarPirateKing01_drinkArm(){
	loader.load('../_models/_scummBar/_chars/scummBarPirateKing01_drinkArm.js',
			function (geometry, materials){
				...
				scummBarPirateKing01_drinkArm.lookText = "These must be the pirate leaders.";
				scummBarPirateKing01_drinkArm.epOverride = 1;
				scummBarPirateKing01_drinkArm.endPoint = new THREE.Vector3(25.93, 1, 14.74);
...
function loadScummBarPirateKing02_drinkArm(){
	loader.load('../_models/_scummBar/_chars/scummBarPirateKing02_drinkArm.js',
			function (geometry, materials){
				...
				scummBarPirateKing02_drinkArm.lookText = "These must be the pirate leaders.";
				scummBarPirateKing02_drinkArm.epOverride = 1;
				scummBarPirateKing02_drinkArm.endPoint = new THREE.Vector3(25.93, 1, 14.74);
...
function loadScummBarPirateKing03_drinkArm(){
	loader.load('../_models/_scummBar/_chars/scummBarPirateKing03_drinkArm.js',
			function (geometry, materials){
				...
				scummBarPirateKing03_drinkArm.lookText = "These must be the pirate leaders.";
				scummBarPirateKing03_drinkArm.epOverride = 1;
				scummBarPirateKing03_drinkArm.endPoint = new THREE.Vector3(25.93, 1, 14.74);
				loadPaperObject();
			}
	);
};
